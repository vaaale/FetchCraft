"""
Simple example of using FastAPI-MCP to add an MCP server to a FastAPI api.
"""
...
@api.get("/items/", response_model=List[Item], tags=["items"], operation_id="list_items")
...
@api.get("/items/{item_id}", response_model=Item, tags=["items"], operation_id="get_item")
...
@api.post("/items/", response_model=Item, tags=["items"], operation_id="create_item")
...
@api.put("/items/{item_id}", response_model=Item, tags=["items"], operation_id="update_item")
...
@api.delete("/items/{item_id}", tags=["items"], operation_id="delete_item")
...
@api.get("/items/search/", response_model=List[Item], tags=["search"], operation_id="search_items")
