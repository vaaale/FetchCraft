...
class TestFilesystemDocumentSource:
    ...
    async def test_from_file(self, temp_dir):
        ...
        source = FilesystemDocumentSource.from_file(file_path)
    ...
    async def test_encoding_utf8(self, temp_dir):
        ...
        source = FilesystemDocumentSource.from_file(utf8_file)
    ...
    async def test_encoding_fallback(self, temp_dir):
        ...
        source = FilesystemDocumentSource.from_file(iso_file)
    ...
    async def test_empty_file(self, temp_dir):
        ...
        source = FilesystemDocumentSource.from_file(empty_file)
...
class TestFilesystemDocumentSourceConstructors:
    ...
    def test_from_fs_constructor(self):
        ...
        source = FilesystemDocumentSource.from_fs(
            fs=fs,
            directory=Path("/data"),
            pattern="*.csv",
            recursive=False
...
class TestFilesystemDocumentSourceErrorHandling:
    ...
    async def test_nonexistent_file(self):
        ...
        source = FilesystemDocumentSource.from_file(
    ...
    async def test_invalid_encoding(self, tmp_path):
        ...
        source = FilesystemDocumentSource.from_file(binary_file)
