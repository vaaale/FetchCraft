...
class TestSimpleNodeParser:
    ...
    def test_small_document_no_splitting(self):
        ...
        doc = DocumentNode.from_text(text=text, metadata={"source": "test.txt"})
    ...
    def test_multiple_documents(self):
        ...
        doc1 = DocumentNode.from_text(text="First document. " * 20, metadata={"source": "doc1.txt"})
        doc2 = DocumentNode.from_text(text="Second document. " * 20, metadata={"source": "doc2.txt"})
