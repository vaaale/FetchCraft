...
async def setup_rag_system():
    ...
    print("=" * 70)
    print("🚀 RAG Tool API - OpenAPI Integration")
    print("=" * 70)
...
async def query(request: QueryRequest):
    ...
    try:
        ...
        html_output = render_response(
            heading="Answer generated by Wingman 🤖",  # <-- new optional heading
            answer=answer,
...
def main():
    ...
    print("\n" + "=" * 70)
    print("🚀 Starting RAG Tool API Server")
    print("=" * 70)
    print(f"\nConfiguration:")
    print(f"  • Host: {HOST}")
    print(f"  • Port: {PORT}")
