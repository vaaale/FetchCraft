...
from fetchcraft.source import PDFDocumentSource
...
async def example_single_pdf():
    ...
    # Create PDF source
    source = PDFDocumentSource.from_file(pdf_path)
...
async def example_directory_pdfs():
    ...
    # Create PDF source for directory
...
async def example_page_chunks():
    ...
    # Create source with page_chunks enabled
    source = PDFDocumentSource.from_file(
        pdf_path,
        page_chunks=True
    )
